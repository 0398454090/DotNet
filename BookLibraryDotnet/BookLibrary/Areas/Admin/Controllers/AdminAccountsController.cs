...
namespace BookLibrary.Areas.Admin.Controllers
{
    ...
    public class AdminAccountsController : Controller
    {
        ...
        public AdminAccountsController(dbBookLibraryContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var dbBookLibraryContext = _context.Accounts.Include(a => a.Role);
            return View(await dbBookLibraryContext.ToListAsync());
        }
